...
class CustomListView(QTreeWidget):
                ...
                for ref in refs:
                    for tup in processed_refs_tuple: #checks if ref has already been processed
                        if ref in tup[0][0]:
                            ...
                            original_item.setData(4,0,ref_indexes) #storing duplicate associated ref in the current found parameter
                            break
    ...
    def addLeaf(self, ref, prev, original_item, index_of_original_item, ref_indexes):
        ...
        original_item.setData(4,0,ref_indexes) #storing all associated references in the original parameter item
